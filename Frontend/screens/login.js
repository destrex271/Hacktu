    ...
    <View style={global.back}>
      ...
      <View style={loginStyles.containerTop}>
        <Pressable
          ...
          onPress={backToHome}
        >
          <Text style={loginStyles.arrow}>{arrow}</Text>
        </Pressable>
        <LogoSvg width="150" style={loginStyles.logo} />
      </View>
      <View style={loginStyles.formContainer}>
        ...
        />
        <Pressable style={[welcomeStyles.noBodyBtn, global.left]}>
          <Text style={[welcomeStyles.buttonTxt, welcomeStyles.yellow]}>
            Forgot Passwod?
          </Text>
        </Pressable>
        <Pressable
          style={[loginStyles.button, loginStyles.bottomShadow]}
      ...
      <View style={loginStyles.textBox}>
        <Text style={loginStyles.disText}>By continuing you agree to our</Text>
        <Text style={[loginStyles.disText, loginStyles.yellow]}>
          {" "}
          Terms of Services
        </Text>
        <Text style={loginStyles.disText}> & </Text>
        <Text style={[loginStyles.disText, loginStyles.yellow]}>
          Privacy Policy.
        </Text>
      </View>
